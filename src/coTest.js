...
class CarInsurance {
  ...
  updatePrice() {
    for (var i = 0; i < this.products.length; i++) {
      ...
      /* UBICACION 1 CONTADOR DIAS 
        ** PUEDE VARIAR SEGUN LOGICA DE NEGOCIO LA UBICACION (RESTA Y CALCULA/CALCULA Y RESTA)
      ...
      */
      ...
      if (this.products[i].name == 'Full Coverage'){
          ...
          if ((this.products[i].sellIn <= 5)&&(this.products[i].sellIn > 0)){
      ...
      /* VALIDACION PRECIO GLOBAL*/
      if (this.products[i].price < 0){
        this.products[i].price = 0;
      }

      /* UBICACION 2 CONTADOR DIAS */
      this.products[i].sellIn = this.products[i].sellIn - 1;
